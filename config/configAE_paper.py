# %%writefile /content/DeepCAD_prashant/config/configAE_paper.py
import os
import json
import shutil
import argparse
...
class ConfigAEPaper(object):
    def __init__(self, phase):
        self.is_train = (phase == 'train')
        self._set_defaults()
        args = self._parse()

        print("---- AE Configuration (Paper) ----")
    ...
    def _set_defaults(self):
        ...
        self.dropout         = 0.1
        self.dim_z           = 256
        self.use_group_emb   = False   # CRITICAL: no leakage
    ...
    def _parse(self):
        ...
        p.add_argument('--exp_name',       type=str,   default='deepcad_ae_paper')
        ...
        p.add_argument('--nr_epochs',      type=int,   default=200)
